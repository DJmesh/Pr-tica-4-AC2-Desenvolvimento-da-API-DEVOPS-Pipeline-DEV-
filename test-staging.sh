...
curl -f http://localhost:8080/v3/api-docs > /dev/null 2>&1 && echo -e "${GREEN}✅ OpenAPI docs accessible${NC}" || echo -e "${YELLOW}⚠️ OpenAPI docs check${NC}"

echo ""
echo -e "${GREEN}=========================================${NC}"
echo -e "${GREEN}✅ STAGING PIPELINE TEST PASSED${NC}"
echo -e "${GREEN}=========================================${NC}"
echo ""
...
echo ""
echo "To stop containers, run: docker-compose -f docker-compose.staging.yml down"
